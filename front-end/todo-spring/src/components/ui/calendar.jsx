    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-10'
        ),
        ...
        day_selected:
          'bg-slate-900 text-slate-50 hover:bg-custom-lighter-dark hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900',
        day_today:
